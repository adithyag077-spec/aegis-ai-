    ...
    <div className="glass-panel p-6 rounded-2xl border border-slate-800 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-slate-800 pb-4 gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="px-3.5 py-2 rounded-xl bg-slate-800 hover:bg-sky-500/20 border border-slate-700 hover:border-sky-500/30 text-sky-400 text-xs font-semibold transition-all flex items-center gap-1.5"
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 text-xs font-mono">
        ...
        <div className="p-3 rounded-xl bg-slate-900/60 border border-slate-800 col-span-2 sm:col-span-1">
          ...
          <span className="font-bold text-emerald-400 text-base">{result.riskScore}/100</span>
        </div>
      </div>
      ...
      {result.indicators && result.indicators.length > 0 && (
        <div className="space-y-2">
          <h4 className="text-xs font-mono uppercase tracking-wider text-slate-400 font-bold">
            Detected Technical Threat Indicators ({result.indicators.length})
          </h4>
